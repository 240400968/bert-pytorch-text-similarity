...
from bert.data import TEXTSIMILARITYDataset
...
if __name__ == "__main__":
    default_config = "../../config/training/text_similarity_training.json"

    parser = argparse.ArgumentParser(description="Train the ESIM model on text_similarity")
    ...
    main(os.path.normpath(os.path.join(script_dir, config["train_data"])),
         os.path.normpath(os.path.join(script_dir, config["matched_valid_data"])),
         os.path.normpath(os.path.join(script_dir, config["mismatched_valid_data"])),
         os.path.normpath(os.path.join(script_dir, config["test_data1"])),
         os.path.normpath(os.path.join(script_dir, config["bert_path"])),
